...
public class TC_NC_026 extends BaseClass {

    @Test
    public void newCustomerAdding() {

        log.info("Entering an email ID with a leading space...");
        String invalidEmail = " " + randomeString() + "@gmail.com";
        acp.enterEmailId(invalidEmail);
